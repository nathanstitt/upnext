...
#define LV_FONT_CUSTOM_DECLARE LV_FONT_DECLARE(font_lato_18)
// LV_FONT_DECLARE(font_lato_24) LV_FONT_DECLARE(font_icon_14)


/*Always set a default font*/
#define LV_FONT_DEFAULT &font_lato_18 // lv_font_montserrat_16
