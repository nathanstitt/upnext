...
#define BSP_LCD_DB0     (GPIO_NUM_47) // 33 or 47
...
#define BSP_LCD_CS      (GPIO_NUM_37)

#define BSP_LCD_DC      (GPIO_NUM_36)
// in question ^ is the RS pin
#define BSP_LCD_WR      (GPIO_NUM_35)
#define BSP_LCD_RD      (GPIO_NUM_48) // 34 or 48
#define BSP_LCD_RST     (-1/*GPIO_NUM_36*/)
// cant figure out the last 3
//#define BSP_LCD_WAIT    (GPIO_NUM_1)

#define BSP_LCD_BL      (GPIO_NUM_45) 
#define BSP_LCD_TP_INT  (GPIO_NUM_40)
